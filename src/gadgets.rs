...
pub trait XorOps<F: RichField + Extendable<D>, const D: usize> {
    fn add_xor3(&mut self, a: Vec<BoolTarget>, b: Vec<BoolTarget>, c: Vec<BoolTarget>) -> Vec<BoolTarget>;
    fn add_maj(&mut self, a: Vec<BoolTarget>, b: Vec<BoolTarget>, c: Vec<BoolTarget>) -> Vec<BoolTarget>;
    fn add_ch(&mut self, a: Vec<BoolTarget>, b: Vec<BoolTarget>, c: Vec<BoolTarget>) -> Vec<BoolTarget>;
}
