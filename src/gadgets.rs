...
use plonky2::{
    ...
    plonk::{
        ...
        circuit_data::{CircuitConfig, CircuitData}, config::GenericConfig,
    },
};
...
pub trait U32SplitOps<F: RichField + Extendable<D>, const D: usize> {
    ...
    fn add_u32_split<const K1: usize, const K2: usize, const K3: usize>(&mut self, input: Target) -> (Target, Target, Target, Target);
}
...
impl<F: RichField + Extendable<D>, const D: usize> U32SplitCircuitBuilder<F, D> {
    ...
    pub fn split<const K1: usize, const K2: usize, const K3: usize>(&mut self, input: &U32Target) -> (Target, Target, Target, Target) {
